...
class DataTranslated(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<DataTranslated> =
            object : Parcelable.Creator<DataTranslated> {
                override fun createFromParcel(source: Parcel): DataTranslated =
                    DataTranslated(source)

                override fun newArray(size: Int): Array<DataTranslated?> = arrayOfNulls(size)
            }
    }
}