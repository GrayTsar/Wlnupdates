...
class DataOriginal(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<DataOriginal> = object : Parcelable.Creator<DataOriginal> {
            override fun createFromParcel(source: Parcel): DataOriginal = DataOriginal(source)
            override fun newArray(size: Int): Array<DataOriginal?> = arrayOfNulls(size)
        }
    }
}