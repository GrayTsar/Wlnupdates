...
class WatchList(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<WatchList> =
            object : Parcelable.Creator<WatchList> {
                override fun createFromParcel(source: Parcel): WatchList = WatchList(source)
                override fun newArray(size: Int): Array<WatchList?> = arrayOfNulls(size)
            }
    }
}